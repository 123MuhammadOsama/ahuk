...
const OrderPage = () => {
  ...
  return (
    <div className="my-32 flex flex-col justify-center">
      <h1 className="text-[70px] text-primary font-bold text-center ">
        Order Now
      </h1>
      <div className="flex flex-col xl:flex-row xl:px-12 2xl:px-16 gap-y-10 items-center xl:items-start justify-center">
        {/* form */}
        <form onSubmit={onSubmit} className="flex flex-col xl:flex-row gap-y-12 gap-x-10 justify-between items-center xl:pr-10 2xl:pr-20">
          <div
            className="p-5 bg-primary/10  rounded-xl w-[350px] md:w-[550px] xl:w-[800px] 2xl:w-[1000px] gap-y-4 flex flex-col items-center"
            style={{
              boxShadow: "rgba(0, 0, 0, 0.25) 0px 25px 50px -12px",
            }}
          >
            <span className="text-primary text-xl tracking-tight py-4">
              Your Requirements
            </span>
              ...
              <div className="flex-wrap flex gap-x-4 gap-y-4">
                {Object.keys(pricingData.academicLevels).map((level) => (
                  ...
                  >
                    ...
                    <label
                      htmlFor={level}
                      className={`select-none p-2 cursor-pointer rounded-r-xl rounded-tl-xl border border-primary transition-all ${
                        academicLevel === level
                      ...
                      style={{
                        ...
                        backgroundColor:
                          academicLevel === level ? "#042E58" : "#fff",
                        color: academicLevel === level ? "#fff" : "#042E58",
            ...
            <div className="gap-x-5 grid grid-cols-1 xl:grid-cols-6 gap-y-5 items-center w-full">
...
<span className="text-primary col-span-6">Note: This price is just an estimation based on the details provided. Real price may be either less or more.</span>
          ...
          <div
          className="p-5 rounded-xl h-[600px] w-[300px]  xl:w-[400px] bg-gradient-to-b from-primary  to-secondary  flex flex-col gap-y-3 items-center  "
          style={{
            boxShadow: "rgba(0, 0, 0, 0.25) 0px 25px 50px -12px",
          }}
        >
          <span className="text-neutral-100 font-bold text-3xl tracking-wider">
            Order Summary
          </span>
          <div className="w-full h-[1px] bg-neutral-400"></div>
          <div className="grid grid-cols-2 text-sm gap-y-3  text-white w-full">
